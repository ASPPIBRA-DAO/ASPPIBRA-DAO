...
import { idlFactory } from './ASPPIBRA-DAO.did.js';
export { idlFactory } from './ASPPIBRA-DAO.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ASPPIBRA_DAO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ASPPIBRA-DAO.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ASPPIBRA-DAO canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ASPPIBRA-DAO.did.js")._SERVICE>}
 */
export const ASPPIBRA_DAO = createActor(canisterId);

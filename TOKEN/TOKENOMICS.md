...
| Objetivo            | Este documento não deve ser interpretado como um prospecto ou uma oferta de valores mobiliários, nem como a promoção de qualquer produto de investimento. O Tokenomics aqui apresentado regula a utilização do Token, suas funções, utilidades e os serviços prestados pela ASPPIBRA-DAO.
